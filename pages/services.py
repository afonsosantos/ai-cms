...
class AIPageGenerator:
    ...
    def _get_previous_page_examples(self, exclude_page_id=None, limit=2):
...
"""
        ...
        try:
            response = self.client.chat.completions.create(
                ...
                messages=[
                    {"role": "system", "content": "You generate valid, responsive HTML pages for CMS systems."},
...
"""
        ...
        try:
            response = self.client.chat.completions.create(
                model=settings.AI_API_MODEL,
                messages=[
                    {"role": "system", "content": "You generate clean and professional HTML layout templates."},
                    {"role": "user", "content": prompt}
                ]
            )
